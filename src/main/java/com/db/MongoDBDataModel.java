...
public final class MongoDBDataModel implements DataModel {
    ...
    private static final String DEFAULT_MONGO_DB = "recsys";
    ...
    private static final String DEFAULT_MONGO_USERNAME = "admin";

    /** Default MongoDB password. Default: recommender */
    private static final String DEFAULT_MONGO_PASSWORD = "admin";

    /** Default MongoDB table/collection. Default: items */
    private static final String DEFAULT_MONGO_COLLECTION = "3336";
